            ...
            <List>
...

                {
                    ...
                    <>
                            ...
                            <ListSubheader>Tarea</ListSubheader>
                            <ListItem 
                                button
                                onClick={ () => navigateTo('/installation/clients') }>
                                <ListItemIcon>
                                    <AddBox/>
                                </ListItemIcon>
                                <ListItemText primary={'Crear nueva'} />
                            </ListItem>
                            <ListItem 
                                button
                                onClick={ () => navigateTo('/installation/user') }>
                                <ListItemIcon>
                                    <FormatListNumbered/>
                                </ListItemIcon>
                              ...
                              <ListItem 
                                button
                                onClick={ () => navigateTo('/installation/list') }>
                                <ListItemIcon>
                                    <AdminPanelSettings/>
                                </ListItemIcon>
                            ...
                            <ListSubheader>Licencias</ListSubheader>
